...
CONFIG = {
    ...
    "MODEL_TARGET_TYPE": "gaussian",
    "MODEL_NUM_JOINTS": 294,
    "EXTRA": dict[
        Literal["PRETRAINED_LAYERS", "FINAL_CONV_KERNEL", "STAGE2", "STAGE3", "STAGE4"],
        Any,
    ](
        {
            "PRETRAINED_LAYERS": [
    ...
    def __init__(self, **kwargs):
        ...
        if self.model_name == "pose_hrnet" or "pose_metric_gcn":
            self.final_layer = nn.Conv2d(
                ...
                out_channels=CONFIG["MODEL_NUM_JOINTS"],
...
def get_pose_net(**kwargs):
    return PoseHighResolutionNet(**kwargs)
