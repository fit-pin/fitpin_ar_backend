...
-   요청시 반드시 URL 끝에 `/` 붙어야 합니다
    ...
    > https://fitpin.kro.kr/ar-api/bodymea (x) <br>
...
### [**POST**] [/bodymea/](https://fitpin.kro.kr/ar-api/bodymea/): 사진을 분석하여 체형을 측정 합니다
...
### [**POST**] [/clothesmea/](https://fitpin.kro.kr/ar-api/clothesmea/): 오프라인 의류 측정을 진행합니다.
...
### [**POST**] [/getnukki/](https://fitpin.kro.kr/ar-api/getnukki/): 의류 이미지에 누끼를 땁니다.
